...
repository root (or the repository at `$AEO_LOOP_REPO` if set). That file
is the Codex-side analog of the Claude `SKILL.md` and specifies the
8-step loop, prompt-injection defense, decisioning rule, and Codex
delegation map.
